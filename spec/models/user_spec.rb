...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    context '新規登録できる場合' do
      it 'email,nickname,password,password_confirmation,last_name,first_name,last_name_kana,first_name_kana,birthdayが存在すれば登録できる' do
    ...
    context '新規登録できない場合' do
      ...
      it 'last_nameが全角で入力されないと登録できない' do
        @user.last_name = 'abc'
        @user.valid?
        expect(@user.errors.full_messages).to include("Last name is invalid")
      end

      it 'first_nameが全角で入力されないと登録できない' do
        @user.first_name = 'abc'
        @user.valid?
      ...
      it 'last_name_kanaが全角で入力されないと登録できない' do
        @user.last_name_kana = 'abc'
        @user.valid?
        expect(@user.errors.full_messages).to include("Last name kana is invalid")
      end

      it 'first_name_kanaが全角で入力されないと登録できない' do
